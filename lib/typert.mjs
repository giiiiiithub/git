import { n as gitErrorSchema, t as DESCRIPTORS } from "./descriptors-CctyRWpi.mjs";
		...
		services: [{
			...
			members: [
				...
				},
				{
					...
					signature: "async getFromRevision(request: GitGetFromRevisionRequest): Promise<GitGetFromRevisionResult>"
				}
			],
			types: [
				{
				...
				{
					name: "GitGetFromRevisionRequest",
					declaration: "export interface GitGetFromRevisionRequest { readonly dir: string; readonly paths: string[]; readonly revision: string; }"
				},
				{
					name: "GitGetFromRevisionResult",
					declaration: "export type GitGetFromRevisionResult = GitResult<{ paths: string[] }>;"
				},
				{
				...
				},
				{
					...
					declaration: "export interface GitRebaseListRequest { readonly dir: string; readonly base?: string; }"
				},
				{
